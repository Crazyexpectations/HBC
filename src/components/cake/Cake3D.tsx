...
const CANDLE_COLORS = ['#ff5c8a', '#f6c453', '#ffb6c9', '#c9184a', '#ffd27a'];
  ...
  return (
    <group ref={group}>
      ...
      <mesh position={[0, -0.02, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#fff6f0" roughness={0.3} metalness={0.4} />
      </mesh>

      {/* bottom tier */}
      <mesh position={[0, 0.35, 0]} castShadow receiveShadow>
        <cylinderGeometry args={[1.35, 1.4, 0.7, 48]} />
        <meshStandardMaterial color="#f8d9e3" roughness={0.55} />
      </mesh>

      {/* top tier */}
      <mesh position={[0, 0.85, 0]} castShadow receiveShadow>
        <cylinderGeometry args={[0.95, 1.0, 0.55, 48]} />
        <meshStandardMaterial color="#ffe3ec" roughness={0.55} />
      </mesh>
      ...
      <mesh position={[0, 0.6, 0]} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color="#c9184a" roughness={0.4} />
      </mesh>
